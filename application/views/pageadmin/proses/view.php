                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    if (data[i].ReqStatus == 1) {
                        button = '<td class="project-actions">' +
                            '   <button  class="btn btn-success btn-sm item_approve"  data-id="' + data[i].id + '">' +
                        ...
                        button = '<td class="project-actions text-left">' +
                            ...
                            '</button> ' +
                            '</td>';
                        status = '<td class="project-state"><span class="badge badge-success"> Received </span></td>'
                    }
