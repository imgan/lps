...
<head>
  ...
  <title>Indirect Control | Log in</title>
  ...
  <!-- Ionicons -->
	<link rel="icon" href="<?= base_url() ?>assets/website/icon.png" type="image/icon type">
...
<div class="login-box">
<div >	
    <img src="<?= base_url() ?>assets/atas2.png" width="365px">
  </div>
