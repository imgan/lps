<section class="content">
    ...
    <div id="modalPop" class="modal fade" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form class="form-horizontal" role="form" id="formPop">
                    <div class="card card-info">
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Request</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script type="text/javascript">
    ...
    $('#show_data').on('click', '.item_stop_buyer', function() {
        var id = $(this).data('id');
        Swal.fire({
            title: 'Apakah anda yakin?',
            text: "Anda mengubah Request menjadi Selesai",
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('administrator/request/buyerstop') ?>",
                    async: true,
                    dataType: "JSON",
                    data: {
                        id: id,
    ...
    $('#show_data').on('click', '.item_stop_ipps', function() {
        var id = $(this).data('id');
        Swal.fire({
            title: 'Apakah anda yakin?',
            text: "Anda mengubah Request menjadi aktif",
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('administrator/request/ippsstop') ?>",
                    async: true,
                    dataType: "JSON",
                    data: {
                        id: id,
    ...
    $('#show_data').on('click', '.item_start_buyer', function() {
        var id = $(this).data('id');
        Swal.fire({
            title: 'Apakah anda yakin?',
            text: "Anda mengubah Request menjadi aktif",
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('administrator/request/buyeraktif') ?>",
                    async: true,
                    dataType: "JSON",
                    data: {
                        id: id,
    ...
    $('#show_data').on('click', '.item_start_item', function() {
        var id = $(this).data('id');
        Swal.fire({
            title: 'Apakah anda yakin?',
            text: "Anda mengubah Request menjadi aktif",
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('administrator/request/itemktif') ?>",
                    async: true,
                    dataType: "JSON",
                    data: {
                        id: id,
    ...
    $('#show_data').on('click', '.item_stop_item', function() {
        var id = $(this).data('id');
        Swal.fire({
            title: 'Apakah anda yakin?',
            text: "Anda mengubah Request menjadi aktif",
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('administrator/request/itemstop') ?>",
                    async: true,
                    dataType: "JSON",
                    data: {
                        id: id,
